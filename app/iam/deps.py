...
# Репозитории соседних доменов собираем здесь, а не берём из их deps.py: те
# импортируют get_current_user отсюда, вышел бы цикл. Сессия одна на запрос -
# каскад удаления аккаунта идёт одной транзакцией.
