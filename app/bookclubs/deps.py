...
# ThreadRepository создаём напрямую от db, а не через app.discussions.deps -
# иначе получился бы циклический импорт (discussions.deps импортирует bookclubs.deps).
