...
## Conformance
Реализация конформна, когда выполняет поведения 1-9, держит инварианты портов и пагинации и правила отказов 1-4. Проверяется тестами tests/threads/ и tests/comments/.
