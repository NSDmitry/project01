...
## Conformance
Реализация конформна, когда выполняет поведения 1-10, держит инварианты уникальности лайка, логических ссылок и счётчика комментариев и правила отказов 1-2. Проверяется тестами tests/threads/, tests/comments/ и tests/bookclubs/test_denormalized_counters.py.
