...
6. Пагинация MUST принимать `limit` 1-100 (default 20) и `offset` >= 0.
...
## Conformance
Реализация конформна, когда выполняет поведения 1-6 и правила отказов 1-6; коды задекларированы в `responses` роутов, проверяются тестами tests/bookclubs/.
