...
13. IF книга уже номинирована в клубе или список кандидатов полон, THEN POST /{club_id}/nominations MUST вернуть 409; IF тома с таким идентификатором нет - 404.
14. IF в клубе нет ни одной номинации, THEN POST /{club_id}/nominations/close MUST вернуть 409.
15. IF номинация не найдена - в том числе если голосование закрыли, пока клиент голосовал, - THEN ручки голоса MUST вернуть 404, а не ошибку сервера; IF голоса за неё не было, THEN DELETE /vote MUST вернуть 409.
