...
- Инвариант: заходы, этапы, прогресс, приглашения, заявки, номинации и голоса удалённого клуба уносит каскад БД по club_id - кода для этого нет.
